...
import Table from '../components/modules/sliders/Table'
import { Stack, Typography } from '@mui/material'
import UsePagination from '../components/modules/sliders/Pagination'
...
export default function Sliders() {
  ...
  const handelChengeCount = async (e) => {
    const news = await ImagesApi.get(e.target.value, 1)
