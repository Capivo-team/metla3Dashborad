...
import Table from '../components/modules/Exchange/Table'
import { Stack, Typography } from '@mui/material'
import UsePagination from '../components/modules/Exchange/Pagination'
...
export default function Exchange() {
  ...
  const handelChengeCount = async (e) => {
    const news = await ExchangeApi.get(e.target.value, 1)
