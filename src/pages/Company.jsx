...
import Table from '../components/modules/company/Table'
import { Stack, Typography } from '@mui/material'
import UsePagination from '../components/modules/company/Pagination'
import { useState } from 'react'
import Apiservices from '../services/ApiServices'
import CompanyApi from '../Api/news'
...
export default function Company() {
  ...
  const handelChengeCount = async (e) => {
    const news = await CompanyApi.get(e.target.value, 1)
