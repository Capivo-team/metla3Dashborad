...
import Table from '../components/modules/Questions/Table'
import { Stack, Typography } from '@mui/material'
import UsePagination from '../components/modules/Questions/Pagination'
...
export default function Questions() {
  ...
  const handelChengeCount = async (e) => {
    const news = await QuestionsApi.get(e.target.value, 1)
